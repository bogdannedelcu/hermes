	<script type="text/javascript" src="https://web.transelectrica.ro/prosumatori/judete1.js"></script>
	<?php
	
	$button0 = new \Kendo\UI\Button('uploadTranselectrica');
	$button0->icon('k-icon k-i-download');
	$button0->click('function(e) { uploadTranselectrica(); }');

	echo $button0->render();
	
	$button0 = new \Kendo\UI\Button('uploadManualTranselectrica');
	$button0->icon('k-icon k-i-upload');
	$button0->click('function(e) { uploadManualTranselectrica(); }');
